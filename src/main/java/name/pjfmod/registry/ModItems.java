...
public class ModItems {
    public static  final Item PJFTEST=registerItem("pjftest",
            new Item(new FabricItemSettings()),ModItemGroup.PJFTEST, ItemGroups.INGREDIENTS);
    public static Item registerItem(String name, Item item, ItemGroup... itemGroups){
        Item registeredItem = Registry.register(Registries.ITEM,new Identifier(Pjfmod.MOD_ID,name),item);
